...
@Al-Shehbaz2002 merged the genera on the basis of molecular, morphological,
...
knitr::include_graphics(
  path = paste0("Figs/FigIntroPriors.", knitr_ext[[knitr_chunk]])
)
...
knitr_section(
  ...
  knitr_type = "subsection", chunk_type = knitr_chunk
)
...
the latter circumsriptions, reporting *P. vitulifera* from only Colorado.
...
*P. vitulifera*, many of which were reannotated by Jennings (2004) as
...
spp_carbon_kable <- herbarium_specimens %>%
...
knitr::include_graphics(
  path = paste0("Figs/FigIntroCarbonWyo.", knitr_ext[[knitr_chunk]])
)
...
With a greater proportion of sequence data constituting simulatenous analyses
...
\paragraph{} Given the assymetry between phylogenies built on molecular and
...
infomation about genetic history, cytology, or reproductive mechanisms 
