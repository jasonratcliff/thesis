...
```{r subsectionDescriptionPdidymocarpaSspLanata}

knitr_section(
  knitr_title = paste(
    "*Physaria didymocarpa* (Hooker) A. Gray subsp. *lanata*",
    "(A. Nelson) O'Kane"
  ),  knitr_type = "subsection", chunk_type = knit_variables$pandoc
)
...
```{r subsectionDescriptionPdidymocarpaSspLyrata}

knitr_section(
  knitr_title = paste(
    "*Physaria didymocarpa* (Hooker) A. Gray subsp. *lyrata*",
...
```{r subsectionDescriptionPeburniflora}

knitr_section(
  knitr_title = "*Physaria eburniflora* Rollins",
  knitr_type = "subsection", chunk_type = knit_variables$pandoc
)
