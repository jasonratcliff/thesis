...
knitr::include_graphics(
  path = paste0("Figs/FigResultsTraitReplums.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsTraitOvules.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsTraitApices.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsTraitTrichomes.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsTraitMargins.", knit_variables$graphics)
)
