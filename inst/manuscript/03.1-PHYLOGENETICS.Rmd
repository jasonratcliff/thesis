...
knitr::include_graphics(
  path = system.file(
    fs::path("figures/ResultsBayes_rITS", ext = knit_variables$graphics),
    package = "Thesis"
  )
)
...
knitr::include_graphics(
  path = system.file(
    fs::path("figures/ResultsBayes_rps", ext = knit_variables$graphics),
    package = "Thesis"
  )
)
...
knitr::include_graphics(
  path = system.file(
    fs::path("figures/ResultsBayes_ML", ext = knit_variables$graphics),
    package = "Thesis"
  )
)
...
knitr::include_graphics(
  path = system.file(
    fs::path("figures/ResultsBeastMultiLocus", ext = knit_variables$graphics),
    package = "Thesis"
  )
)
...
knitr::include_graphics(
  path = system.file(
    fs::path("figures/ResultsBeastGeography", ext = knit_variables$graphics),
    package = "Thesis"
  )
)
...
knitr::include_graphics(
  path = system.file(
    fs::path("figures/ResultsBeastSpecies", ext = knit_variables$graphics),
    package = "Thesis"
  )
)
