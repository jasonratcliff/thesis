...
monophyletic groups in the rITS gene tree Figure \@ref(fig:FigureResultsBayesrITS).
...
Thesis::knitr_section(
  knitr_title = "Multilocus Analyses",
  knitr_type = "subsection", chunk_type = knit_variables$pandoc
)
