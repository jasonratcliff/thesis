...
knitr::include_graphics(
  path = paste0("Figs/FigDiscussionTraitReplums.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigDiscussionTraitOvules.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigDiscussionTraitApices.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigDiscussionTraitTrichomes.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigDiscussionTraitMargins.", knit_variables$graphics)
)
