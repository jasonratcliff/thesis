...
\begin{enumerate}
  ...
  Medicine Bow Mountains and Sierra Madre Range of SC Wyoming, NC Colorado
...
```{r subsectionDescriptionPhysariaSpNov}

knitr_section(
  knitr_title = "*Physaria* ‘medicinae’",
  knitr_type = "subsection", chunk_type = knit_variables$pandoc
)
