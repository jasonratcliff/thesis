...
```{r FigureIntroPriors, fig.cap=caption$FigureIntroPriors, fig.scap="Reviewed \\textit{Physaria} herbarium specimen records by prior annotation"}

caption$FigureIntroPriors <-
  paste(
    "Distribution of reviewed ",
    physaria(knitr_chunk = knit_variables$kable_format),
    "herbarium specimens by most recent annotation."
  )
