...
```{r FigureIntroPriors, fig.cap=caption$FigureIntroPriors, fig.scap="Distribution of \\textit{Physaria} herbarium specimen vouchers by prior annotation"}

caption$FigureIntroPriors <-
  paste("Distribution of",
    physaria(knitr_chunk = knit_variables$kable_format),
    "herbarium specimen vouchers by prior annotation."
  )
...
caption$TableIntroCarbon <-
  paste("Putative Carbon County, Wyoming",
    ifelse(
      test = knit_variables$pandoc == "latex",
      yes = "\\textit{Physaria vitulifera}",
      no = "*Physaria vitulifera*"
    ), "specimens"
  )
