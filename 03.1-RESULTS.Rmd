...
\paragraph{} Sequencing of the *ycf1* loci revealed a low mutation rate in this group of taxa for that marker.  Specimens sampled from each of the putative species considered in this study had identical sequences, with 34 individuals having an identical genotype (Table \@ref(tab:resultsTable3IdenticalSeqYcf1)).  Those showing some degree of heterogeneity for this loci included specimes of *P. acutifolia* (n=2), *P. brassicoides* (n=2), *P. integrifolia* (n=2), *P. eburniflora* (n=2), *P. condensata* (n=1), *P. didymocarpa* subsp. *didymocarpa* (n=1), *P. d.* subsp. *lanata* (n=1), and one specimen from the Medicine Bow Range (*Fertig 16713*).  Due to the high degree of homogeneity observed for this marker, an individual gene tree analysis was not carried out.
