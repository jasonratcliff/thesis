...
\clearpage
\vspace{-26pt}
\subsection{\textit{ycf1} Sequence Analysis}
...
```{r resultsTable3IdenticalSeqYcf1}
...
```{r resultsTable3IdenticalSeqYcf12}
...
\subsection{Concatenated Multi-locus Analysis}

```{r chapterSubsectionMultiLocus, results = "asis", eval=FALSE}
...
```{r resultsTable4IdenticalSeqML, warning=FALSE}
