...
```{r resultsFigure3rpsPhyloTree, fig.cap=knitr_cap, fig.height=10, fig.asp=1.3}
...
ycf1_table_cap <- paste0("$Physaria$ DNA specimens with identical genotypes",
                       " for the $ycf1$ loci.")

if (knitr_chunk == "html") {
  phylo_kable(tbl_multi_node = ycf1_id_seqs,
              kable_caption = ycf1_table_cap)
} else if (knitr_chunk == "latex") {
...
```{r resultsFigure4MultiLocusPhyloTree, fig.cap=knitr_cap, fig.width=8, fig.asp=1.3}
