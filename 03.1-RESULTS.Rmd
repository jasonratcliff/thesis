...
```{r resultsTable4IdenticalSeqITS}
...
```{r resultsFigure2rITSPhyloTree, fig.width=8, fig.asp=1.3, fig.cap=knitr_cap}
...
```{r resultsTable5IdenticalSeqRps}
...
```{r resultsTable5IdenticalSeqRpsCont}
...
```{r resultsFigure3rpsPhyloTree, fig.cap=knitr_cap, fig.width=6.6, fig.asp=1.3}
