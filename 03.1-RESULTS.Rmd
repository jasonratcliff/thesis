...
write.csv(ycf1_id_seqs, row.names = FALSE,
          file = "Phys_DNA/Seq-Tables/ycf1_identical_seqs-table.csv")

latex_kable(id_seq_csv = "Phys_DNA/Seq-Tables/ycf1_identical_seqs-table.csv",
