...
`r knitr_table_dna(knit_variables$pandoc)`). For the narrowly distributed Wyoming state
...
were included. Sequence data were obtained from
...
if (knit_variables$pandoc == "latex") {
  methods_variables$collections %>% dplyr::slice(1:39) %>%
    kable(x =., format = knit_variables$pandoc, escape = FALSE,
    ...
    footnote(general = methods_variables$dna_footnote, general_title = "",
...
# HTML specimen table
if (knit_variables$pandoc == "html" | knit_variables$pandoc == "docx") {
...
methods_variables$primers <- methods_variables$primers %>%
  kable(x = ., format = knit_variables$kable_format,
        align = "l", escape = FALSE,
        caption = "Primer Sequences for PCR Reactions.")

if (knit_variables$pandoc == "html" | knit_variables$pandoc == "latex") {
  methods_variables$primers %>%
    kable_styling(full_width = FALSE, font_size = 10) %>%
    row_spec(row = 0, bold = TRUE, font_size = 12) %>%
...
if (knit_variables$pandoc == "latex") {
  methods_variables$star_beast <- methods_variables$star_beast %>%
    mutate(
...
methods_variables$star_beast <- methods_variables$star_beast %>%
  kable(
    x = ., format = knit_variables$kable_format,
    align = "l", escape = FALSE,
