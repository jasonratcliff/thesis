...
link_spp_xlsx <- 
  paste0(
    ...
    "blob/master/inst/extdata/specimens.xlsx"
  )
link_spp_script <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "blob/master/data-raw/specimens/herbarium_specimens.R"
  )
link_fasta <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "blob/master/inst/extdata/FASTA"
  )
link_seq_subset <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/sequencing/2.subset-fastas"
  )
link_aln_single <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/sequencing/3.alignments-single"
  )
link_aln_concat <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/sequencing/3.alignments-subset"
  )
link_script_concat <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "blob/master/data-raw/sequencing/fasta-concat.R"
  )
link_multilocus <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/sequencing/3.multi-locus"
  )
link_bayes_mega <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/Bayes/MEGA"
  )
link_bayes_nexus <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/Bayes/Runs"
  )
link_beast_nexus <-
  paste0(
    "https://github.com/jasonratcliff/ThesisPackage/",
    "tree/master/data-raw/BEAST/"
  )
```
...
`herbarium_specimens` in the `ThesisPackage` namespace.
...
- Combine DNA specimen metadata from `specimens/dna_specimens.csv`
    - Create *dna_specimens.Rda* with tibble in the `ThesisPackage` namespace
