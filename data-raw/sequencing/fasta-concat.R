...
ml_aligned <-
  list.files(
    path = "data-raw/sequencing/3.alignments-subset",
...
ml_concat <- purrr::map2(
  ml_aligned, fasta_matches,
...
Biostrings::writeXStringSet(ml_concat,
  width = 1999,
  filepath = paste0(
    "data-raw/sequencing/3.multi-locus/",
