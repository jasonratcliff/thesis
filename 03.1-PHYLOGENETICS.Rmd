...
knitr::include_graphics(
  path = paste0("Figs/FigResultsBayes_rITS.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsBayes_rps.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsBayes_ML.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsBeastMultiLocus.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsBeastGeography.", knit_variables$graphics)
)
...
knitr::include_graphics(
  path = paste0("Figs/FigResultsBeastSpecies.", knit_variables$graphics)
)
