...
% Three part table call of kableExtraa requires LaTeX package "makecell"
\usepackage{makecell}
...
\titleformat{name=\chapter}[display] % Define chapter typesetting.
  {\normalsize\filcenter}{CHAPTER \thechapter}{10pt}{}{}
\titleformat{name=\chapter,numberless}[display]
  {\normalsize\filcenter}{}{10pt}{}{}
\titleformat{name=\section}[display]  
  {\normalfont\filcenter}{}{10pt}{\uline}{}
\titleformat{name=\subsection}[display]  
  {\normalfont\filright}{}{10pt}{\uline}{}
\titleformat{name=\subsection,numberless}[display]  
  {\normalfont\filright}{}{10pt}{\uline}{}
  
% Adjust spacing for title sections
\titlespacing*{name=\chapter}{0pt}{0pt}{10pt}
\titlespacing*{name=\chapter,numberless}{0pt}{-33pt}{0pt}
\titlespacing*{name=\section}{0pt}{-33pt}{0pt}
\renewcommand\thesection{}
\titlespacing*{name=\subsection}{0pt}{-33pt}{0pt}
\renewcommand\thesubsection{}
\titlespacing*{name=\subsection,numberless}{0pt}{-33pt}{5pt}
\titlespacing*{name=\paragraph}{0pt}{0pt}{4em} % Set paragraph indent
...
\renewcommand{\lstlistingname}{Appendix Figure}
\lstset{language=mybash, % Set language as my defined bash dialect
  frame=single, % box frame around code
  framesep=10pt,  % margin separation
